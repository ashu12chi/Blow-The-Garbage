			...
			try {
				if (isGarbage) {
					...
					try {
						...
						Garbage garbageUpload = new Garbage(garbage[garbageIndex], false, false, mLastKnownLocation.getLatitude(), mLastKnownLocation.getLongitude(), 0, true, "No-url", MOB_NUMBER, upvoters);
